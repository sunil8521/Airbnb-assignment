...
function LaurelWreathIcon({ flipped = false }: { flipped?: boolean }) {
  return (
    <svg
      viewBox="0 0 20 32"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className={`w-5 h-8 shrink-0 ${flipped ? "scale-x-[-1]" : ""}`}
      aria-hidden="true"
    >
      <path
        fillRule="evenodd"
...
export default function ListingInfo({
  ...
  return (
    <div>
      ...
      <h2 className="text-[22px] md:text-[26px] font-semibold text-[#222222] mt-6 tracking-tight">
        {fullLocation}
      </h2>
      <p className="text-[15px] md:text-base text-[#222222] mt-1 font-normal">
        {guests} guests · {bedrooms} bedroom · {beds} bed · {bathrooms} bathroom
      </p>

      
      <div className="flex items-center justify-between mt-6 border border-[#DDDDDD] rounded-2xl px-4 sm:px-6 py-4 sm:py-5 gap-2">
        
        <div className="flex items-center gap-1 shrink-0">
          <LaurelWreathIcon />
          <div className="text-center px-1">
            <p className="text-[14px] md:text-[15px] font-bold leading-[1.1] text-[#222222]">Guest</p>
            <p className="text-[14px] md:text-[15px] font-bold leading-[1.1] text-[#222222]">favourite</p>
          </div>
          <LaurelWreathIcon flipped />
        </div>

        
        <div className="hidden sm:block px-2 md:px-4 flex-1 max-w-[340px]">
          <p className="text-[14px] md:text-[15px] text-[#222222] leading-snug font-normal">
        ...
        <div className="flex items-center shrink-0">
          ...
          <div className="text-center pr-3 sm:pr-5">
            <p className="text-[17px] md:text-[18px] font-bold text-[#222222] leading-none mb-1">
              {rating.toFixed(2)}
            </p>
          ...
          <div className="w-[1px] h-9 bg-[#DDDDDD]" />

          
          <div className="text-center pl-3 sm:pl-5">
            <p className="text-[17px] md:text-[18px] font-bold text-[#222222] leading-none mb-1">
              {reviewCount}
            </p>
            <p className="text-[12px] text-[#222222] underline font-semibold cursor-pointer">
              Reviews
            </p>
          </div>
        </div>
