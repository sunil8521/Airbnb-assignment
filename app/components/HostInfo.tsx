...
interface HostInfoProps {
  host: { name: string; avatar: string; yearsHosting: number };
    ...
    case "outdoor":
      return (
        <svg
          ...
          role="presentation"
          focusable="false"
          className="w-6 h-6 shrink-0 fill-[#222222]"
        >
...
export default function HostInfo({ host, highlights }: HostInfoProps) {
  return (
        ...
        {highlights.map((h) => (
          <div key={h.title} className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-[14px] text-[#717171] mt-0.5 leading-normal">
                {h.description}
              </p>
            </div>
          </div>
